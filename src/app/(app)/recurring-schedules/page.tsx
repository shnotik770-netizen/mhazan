...
export default async function RecurringSchedulesPage() {
  ...
  return (
    <div className="space-y-4">
      <div>
        <h1 className="text-xl font-bold">ניהול הרשאות וחיובים קבועים</h1>
        <p className="text-sm text-muted">
          כל ההרשאות והחיובים הקבועים (הכנסות והוצאות חוזרות) המוגדרים במערכת — הוספה, עריכה, השבתה ומחיקה.
        </p>
      </div>
